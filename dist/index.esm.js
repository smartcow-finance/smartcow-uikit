...
var Logo = function (_a) {
    ...
    return (React.createElement(IconContainer, null, isPushed
        ? React.createElement("img", __assign({}, props, { src: "/images/bakerswap-logo.png", alt: "Bakerswap logo", width: "640", height: "271" }))
        : React.createElement("img", __assign({}, props, { src: "/images/bakerswap-logo-mobile.png", alt: "Bakerswap logo", width: "512", height: "512" }))));
};
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, null,
        ...
        React.createElement(Link, { href: "https://www.smartscan.cash/address/0xa9be42ec46152645d1d4ecfA3AC5Fc587Ce7aCDb", style: { marginLeft: "5px", textDecoration: "none" }, target: "_blank", color: "textSubtle", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
