...
var StyledButton = styled__default['default'].button(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  align-items: center;\n  /* border: 0;\n  border-radius: 0.5rem;\n  box-shadow: 2px 1000px 1px #f7f7f7  inset;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  justify-content: center;\n  letter-spacing: 0.03em;\n  line-height: 1;\n  opacity: ", ";\n  outline: 0;\n  transition: background-color 0.2s;\n\n  border-radius: 0.5rem;\n  //color: ", ";\n\n  border: solid 3px transparent;\n  background-image: linear-gradient(rgba(255,255,255,0),rgba(255,255,255,0)), linear-gradient(90deg,#e38829,#dbd15c);\n  background-origin: border-box;\n  background-clip: content-box, border-box;\n  ", "\n\n  &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n\n  &:active:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled) {\n    opacity: 0.85;\n  }\n\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"], ["\n  align-items: center;\n  /* border: 0;\n  border-radius: 0.5rem;\n  box-shadow: 2px 1000px 1px #f7f7f7  inset;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  justify-content: center;\n  letter-spacing: 0.03em;\n  line-height: 1;\n  opacity: ", ";\n  outline: 0;\n  transition: background-color 0.2s;\n\n  border-radius: 0.5rem;\n  //color: ", ";\n\n  border: solid 3px transparent;\n  background-image: linear-gradient(rgba(255,255,255,0),rgba(255,255,255,0)), linear-gradient(90deg,#e38829,#dbd15c);\n  background-origin: border-box;\n  background-clip: content-box, border-box;\n  ",
    ...
    return !props.disabled
        ? ""
        : " \n    box-shadow: 2px 1000px 1px #d7d1d1 inset;\n    color: rgb(113,113,97);\n    background-image: none;\n    ";
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(IconContainer, null, isPushed
        ? React__default['default'].createElement("img", __assign({}, props, { src: "/images/bakerswap-logo.png", alt: "Bakerswap logo", width: "640", height: "271" }))
        : React__default['default'].createElement("img", __assign({}, props, { src: "/images/bakerswap-logo-mobile.png", alt: "Bakerswap logo", width: "512", height: "512" }))));
};
...
var StyledLink$1 = styled__default['default'](reactRouterDom.Link)(templateObject_1$B || (templateObject_1$B = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n\n  & > div {\n    margin-left: 28px;\n    margin-top: 18px;\n\n    ", " {\n      margin-left: ", ";\n    }\n  }\n\n  .mobile-icon {\n    width: ", ";\n    height: auto;\n\n    ", " {\n      display: none;\n    }\n  }\n\n  .desktop-icon {\n    width: ", ";\n    height: auto;\n    display: none;\n\n    ", " {\n      display: block;\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n\n  & > div {\n    margin-left: 28px;\n    margin-top: 18px;\n\n    ", " {\n      margin-left: ", ";\n    }\n  }\n\n  .mobile-icon {\n    width: ", ";\n    height: auto;\n\n    ", " {\n      display: none;\n    }\n  }\n\n  .desktop-icon {\n    width: ", ";\n    height: auto;\n    display: none;\n\n    ", " {\n      display: block;\n    }\n  }\n"])), function (_a) {
    ...
    return isPushed ? '28px' : '6px';
}, function (_a) {
    var isPushed = _a.isPushed;
    return isPushed ? '136px' : '40px';
}, function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
}, function (_a) {
...
var MenuEntry = styled__default['default'].div(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  font-weight: ", ";\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 400% 100%;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  font-weight: ", ";\n  background-color: ", ";\n  color: ", ";\n  box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ",
    ...
    return secondary ? '#e38829' : theme.colors.textSubtle;
}, function (_a) {
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, null,
        ...
        React__default['default'].createElement(Link, { href: "https://www.smartscan.cash/address/0xa9be42ec46152645d1d4ecfA3AC5Fc587Ce7aCDb", style: { marginLeft: "5px", textDecoration: "none" }, target: "_blank", color: "textSubtle", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#ffffff", secondary: "#52D784", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#452A7A", farmBackground: "#F4F3F6", toggleBackground: "#E6FDFE", textDisabled: "#544786", textSubtle: "#46357B", borderColor: "#E9EAEB", card: "#FFFFFF", nav: "#333333", gradients: {
